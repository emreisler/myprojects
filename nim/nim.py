...
class NimAI():
    ...
    def update(self, old_state, action, new_state, reward):
        ...
        update((0,1,5,0),(2,1),(0,1,4,0),0)

            old = self.get_q_value((0,1,4,0),(2,2)) => 0
            best_future = ((0,1,2,0)) => 0
            self.update_q_value((0,1,4,0),(2,2), 0, 0, 0)
            0 + 0,5 * (0 + 0 -(0,5))
        ...
        #print("------------------")
        #print(old,old_state,action,"old")
        #print("------------------")
        #print(best_future,new_state,"future")
...
def train(n):
    ...
    for key in player.q:
        if player.q[key] == 0:
            ...
            learned += 1
    print("-----------------------")
    print("Total discovered moves : ", learned + notLearned)
    print("Learned moves : ", learned)
    print("Not Learned moves : ", notLearned)
